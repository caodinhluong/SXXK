...
const NhapToKhaiXuat = () => {
    ...
    const handleImportExcel = async (file) => {
        try {
            ...
            const res = await importToKhaiXuatFromExcel(data, selectedLoHang);
            if (res.success) {
            ...
            >
                <div style={{ padding: "16px 0" }}>
                    <p style={{ marginBottom: 16 }}>
                        Chọn file Excel để import tờ khai. Đảm bảo file có các cột: <b>so_tk, ngay_tk, ma_to_khai, loai_hang, cang_xuat, tong_tri_gia</b>
                    </p>
